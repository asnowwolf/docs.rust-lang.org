...
### [Specifying Placeholder Types in Trait Definitions with Associated Types](ch19-03-advanced-traits.html#specifying-placeholder-types-in-trait-definitions-with-associated-types)
...
### [Default Generic Type Parameters and Operator Overloading](ch19-03-advanced-traits.html#default-generic-type-parameters-and-operator-overloading)
...
### [Fully Qualified Syntax for Disambiguation: Calling Methods with the Same Name](ch19-03-advanced-traits.html#fully-qualified-syntax-for-disambiguation-calling-methods-with-the-same-name)
...
### [Using Supertraits to Require One Trait’s Functionality Within Another Trait](ch19-03-advanced-traits.html#using-supertraits-to-require-one-traits-functionality-within-another-trait)
...
### [Using the Newtype Pattern to Implement External Traits on External Types](ch19-03-advanced-traits.html#using-the-newtype-pattern-to-implement-external-traits-on-external-types)
