## [Defining and Instantiating Structs](ch05-01-defining-structs.html#defining-and-instantiating-structs)
...
stating the name of the struct and then add curly brackets containing `key: value` pairs, where the keys are the names
of the fields and the values are the
...
### [Using the Field Init Shorthand when Variables and Fields Have the Same Name](ch05-01-defining-structs.html#using-the-field-init-shorthand-when-variables-and-fields-have-the-same-name)
...
### [Unit-Like Structs Without Any Fields](ch05-01-defining-structs.html#unit-like-structs-without-any-fields)
...
> ### [Ownership of Struct Data](ch05-01-defining-structs.html#ownership-of-struct-data)
>
