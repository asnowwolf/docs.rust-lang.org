## [Closures: Anonymous Functions that Can Capture Their Environment](ch13-01-closures.html#closures-anonymous-functions-that-can-capture-their-environment)
...
### [Creating an Abstraction of Behavior with Closures](ch13-01-closures.html#creating-an-abstraction-of-behavior-with-closures)
...
#### [Refactoring Using Functions](ch13-01-closures.html#refactoring-using-functions)
...
#### [Refactoring with Closures to Store Code](ch13-01-closures.html#refactoring-with-closures-to-store-code)
...
### [Closure Type Inference and Annotation](ch13-01-closures.html#closure-type-inference-and-annotation)
...
### [Storing Closures Using Generic Parameters and the `Fn` Traits](ch13-01-closures.html#storing-closures-using-generic-parameters-and-the-fn-traits)
...
### [Limitations of the `Cacher` Implementation](ch13-01-closures.html#limitations-of-the-cacher-implementation)
...
### [Capturing the Environment with Closures](ch13-01-closures.html#capturing-the-environment-with-closures)
