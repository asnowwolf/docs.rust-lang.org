## [Using `Box<T>` to Point to Data on the Heap](ch15-01-box.html#using-boxt-to-point-to-data-on-the-heap)
...
### [Using a `Box<T>` to Store Data on the Heap](ch15-01-box.html#using-a-boxt-to-store-data-on-the-heap)
...
### [Enabling Recursive Types with Boxes](ch15-01-box.html#enabling-recursive-types-with-boxes)
...
#### [More Information About the Cons List](ch15-01-box.html#more-information-about-the-cons-list)
...
#### [Computing the Size of a Non-Recursive Type](ch15-01-box.html#computing-the-size-of-a-non-recursive-type)
...
<img alt="An infinite Cons list" src="img/trpl15-01.svg" class="center" style="width: 50%;"></img>

<span class="caption">Figure 15-1: An infinite `List` consisting of infinite
`Cons` variants</span>

#### [Using `Box<T>` to Get a Recursive Type with a Known Size](ch15-01-box.html#using-boxt-to-get-a-recursive-type-with-a-known-size)
...
<img alt="A finite Cons list" src="img/trpl15-02.svg" class="center"></img>
