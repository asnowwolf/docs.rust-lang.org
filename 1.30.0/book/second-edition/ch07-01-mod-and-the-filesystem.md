## [`mod` and the Filesystem](ch07-01-mod-and-the-filesystem.html#mod-and-the-filesystem)
...
### [Module Definitions](ch07-01-mod-and-the-filesystem.html#module-definitions)
...
### [Moving Modules to Other Files](ch07-01-mod-and-the-filesystem.html#moving-modules-to-other-files)
...
<span class="caption">Listing 7-4: Extracting the contents of the `client` module but leaving the declaration in
*src/lib.rs*</span>
...
defined within the scope of the `client` module. In other words, the line `mod client;` means this:
...
### [Rules of Module Filesystems](ch07-01-mod-and-the-filesystem.html#rules-of-module-filesystems)
