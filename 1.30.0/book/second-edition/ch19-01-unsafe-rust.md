## [Unsafe Rust](ch19-01-unsafe-rust.html#unsafe-rust)
...
### [Unsafe Superpowers](ch19-01-unsafe-rust.html#unsafe-superpowers)
...
### [Dereferencing a Raw Pointer](ch19-01-unsafe-rust.html#dereferencing-a-raw-pointer)
...
pointers can be immutable or mutable and are written as `*const T` and `*mut T`, respectively. The asterisk isn’t the
dereference operator; it’s part of the
...
### [Calling an Unsafe Function or Method](ch19-01-unsafe-rust.html#calling-an-unsafe-function-or-method)
...
#### [Creating a Safe Abstraction over Unsafe Code](ch19-01-unsafe-rust.html#creating-a-safe-abstraction-over-unsafe-code)
...
#### [Using `extern` Functions to Call External Code](ch19-01-unsafe-rust.html#using-extern-functions-to-call-external-code)
...
> #### [Calling Rust Functions from Other Languages](ch19-01-unsafe-rust.html#calling-rust-functions-from-other-languages)
>
...
### [Accessing or Modifying a Mutable Static Variable](ch19-01-unsafe-rust.html#accessing-or-modifying-a-mutable-static-variable)
...
### [Implementing an Unsafe Trait](ch19-01-unsafe-rust.html#implementing-an-unsafe-trait)
...
### [When to Use Unsafe Code](ch19-01-unsafe-rust.html#when-to-use-unsafe-code)
