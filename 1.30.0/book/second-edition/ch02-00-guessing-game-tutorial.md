# [Programming a Guessing Game](ch02-00-guessing-game-tutorial.html#programming-a-guessing-game)
...
## [Setting Up a New Project](ch02-00-guessing-game-tutorial.html#setting-up-a-new-project)
...
## [Processing a Guess](ch02-00-guessing-game-tutorial.html#processing-a-guess)
...
[the *prelude*](https://doc.rust-lang.org/1.30.0/std/prelude/index.html)<!-- ignore -->. If a type you want to use isn’t
in the
...
[`String`](https://doc.rust-lang.org/1.30.0/std/string/struct.String.html)<!-- ignore --> is a string type provided by
the standard
...
returns an instance of [`std::io::Stdin`](https://doc.rust-lang.org/1.30.0/std/io/struct.Stdin.html)<!-- ignore -->,
which is a
type that represents a handle to the standard input for your terminal.

The next part of the code, `.read_line(&mut guess)`, calls the
[`read_line`](https://doc.rust-lang.org/1.30.0/std/io/struct.Stdin.html#method.read_line)<!-- ignore --> method on the
standard input handle to
...
### [Handling Potential Failure with the `Result` Type](ch02-00-guessing-game-tutorial.html#handling-potential-failure-with-the-result-type)
...
[`io::Result`](https://doc.rust-lang.org/1.30.0/std/io/type.Result.html)<!-- ignore -->. Rust has a number of types
named
`Result` in its standard library: a
generic [`Result`](https://doc.rust-lang.org/1.30.0/std/result/enum.Result.html)<!-- ignore -->
as well as specific versions for submodules, such as `io::Result`.

The `Result` types are [*enumerations*](ch06-00-enums.html)<!-- ignore -->, often referred
...
instance of `io::Result` has
an [`expect` method](https://doc.rust-lang.org/1.30.0/std/result/enum.Result.html#method.expect)<!-- ignore --> that
...
### [Printing Values with `println!` Placeholders](ch02-00-guessing-game-tutorial.html#printing-values-with-println-placeholders)
...
### [Testing the First Part](ch02-00-guessing-game-tutorial.html#testing-the-first-part)
...
## [Generating a Secret Number](ch02-00-guessing-game-tutorial.html#generating-a-secret-number)
...
### [Using a Crate to Get More Functionality](ch02-00-guessing-game-tutorial.html#using-a-crate-to-get-more-functionality)
...
#### [Ensuring Reproducible Builds with the
*Cargo.lock* File](ch02-00-guessing-game-tutorial.html#ensuring-reproducible-builds-with-the-cargolock-file)
...
#### [Updating a Crate to Get a New Version](ch02-00-guessing-game-tutorial.html#updating-a-crate-to-get-a-new-version)
...
ecosystem](http://doc.crates.io/crates-io.html)<!-- ignore --> which we’ll discuss in Chapter 14, but
for now, that’s all you need to know. Cargo makes it very easy to reuse
libraries, so Rustaceans are able to write smaller projects that are assembled
from a number of packages.

### [Generating a Random Number](ch02-00-guessing-game-tutorial.html#generating-a-random-number)
...
> documentation. Another neat feature of Cargo is that you can run the `cargo doc --open` command, which will build
> documentation provided by all of your
...
[`match`](ch06-02-match.html)<!-- ignore --> expression to decide what to do next based on
...
newline character is added to the string. For example, if the user types <span class="keystroke">5</span> and
presses <span class="keystroke">enter</span>,
`guess` looks like this: `5\n`. The `\n` represents “newline,” the result of
pressing <span class="keystroke">enter</span>. The `trim` method eliminates
`\n`, resulting in just `5`.

The [`parse` method on strings](https://doc.rust-lang.org/1.30.0/std/primitive.str.html#method.parse)<!-- ignore -->
parses a string into some
...
## [Allowing Multiple Guesses with Looping](ch02-00-guessing-game-tutorial.html#allowing-multiple-guesses-with-looping)
...
The user could always halt the program by using the keyboard shortcut <span class="keystroke">ctrl-c</span>. But there’s
another way to escape this
...
### [Handling Invalid Input](ch02-00-guessing-game-tutorial.html#handling-invalid-input)
...
## [Summary](ch02-00-guessing-game-tutorial.html#summary)
