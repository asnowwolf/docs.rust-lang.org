## [Reference Cycles Can Leak Memory](ch15-06-reference-cycles.html#reference-cycles-can-leak-memory)
...
### [Creating a Reference Cycle](ch15-06-reference-cycles.html#creating-a-reference-cycle)
...
<img alt="Reference cycle of lists" src="img/trpl15-04.svg" class="center"></img>
...
### [Preventing Reference Cycles: Turning an `Rc<T>` into a `Weak<T>`](ch15-06-reference-cycles.html#preventing-reference-cycles-turning-an-rct-into-a-weakt)
...
#### [Creating a Tree Data Structure: a `Node` with Child Nodes](ch15-06-reference-cycles.html#creating-a-tree-data-structure-a-node-with-child-nodes)
...
#### [Adding a Reference from a Child to Its Parent](ch15-06-reference-cycles.html#adding-a-reference-from-a-child-to-its-parent)
...
#### [Visualizing Changes to `strong_count` and `weak_count`](ch15-06-reference-cycles.html#visualizing-changes-to-strong_count-and-weak_count)
...
## [Summary](ch15-06-reference-cycles.html#summary)
...
smart pointers, check out [“The Rustonomicon”](https://doc.rust-lang.org/stable/nomicon/) for more useful
information.
