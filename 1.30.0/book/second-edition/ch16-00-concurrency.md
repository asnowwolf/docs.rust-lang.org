# [Fearless Concurrency](ch16-00-concurrency.html#fearless-concurrency)
...
shipped to production. We’ve nicknamed this aspect of Rust *fearless**concurrency*. Fearless concurrency allows you to
write code that is free of
