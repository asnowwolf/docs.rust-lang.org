## [Graceful Shutdown and Cleanup](ch20-03-graceful-shutdown-and-cleanup.html#graceful-shutdown-and-cleanup)

The code in Listing 20-21 is responding to requests asynchronously through the
use of a thread pool, as we intended. We get some warnings about the `workers`,
`id`, and `thread` fields that we’re not using in a direct way that reminds us
we’re not cleaning up anything. When we use the less elegant <span class="keystroke">ctrl-c</span> method to halt the
main thread, all other
...
### [Implementing the `Drop` Trait on `ThreadPool`](ch20-03-graceful-shutdown-and-cleanup.html#implementing-the-drop-trait-on-threadpool)
...
### [Signaling to the Threads to Stop Listening for Jobs](ch20-03-graceful-shutdown-and-cleanup.html#signaling-to-the-threads-to-stop-listening-for-jobs)
...
## [Summary](ch20-03-graceful-shutdown-and-cleanup.html#summary)
