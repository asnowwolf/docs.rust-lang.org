## [An Example Program Using Structs](ch05-02-example-structs.html#an-example-program-using-structs)
...
### [Refactoring with Tuples](ch05-02-example-structs.html#refactoring-with-tuples)
...
### [Refactoring with Structs: Adding More Meaning](ch05-02-example-structs.html#refactoring-with-structs-adding-more-meaning)
...
### [Adding Useful Functionality with Derived Traits](ch05-02-example-structs.html#adding-useful-functionality-with-derived-traits)
...
specifier `:?` inside the curly brackets tells
...
continue to refactor this code by turning the `area` function into an `area`*method* defined on our `Rectangle` type.
