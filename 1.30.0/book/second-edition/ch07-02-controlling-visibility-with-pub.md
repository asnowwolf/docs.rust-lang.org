## [Controlling Visibility with `pub`](ch07-02-controlling-visibility-with-pub.html#controlling-visibility-with-pub)
...
### [Making a Function Public](ch07-02-controlling-visibility-with-pub.html#making-a-function-public)
...
`client::connect` has gone unused for now, as well as the `module `client` is private` error from our binary crate.
Modify *src/lib.rs* to make the
...
### [Privacy Rules](ch07-02-controlling-visibility-with-pub.html#privacy-rules)
...
### [Privacy Examples](ch07-02-controlling-visibility-with-pub.html#privacy-examples)
...
#### [Looking at the Errors](ch07-02-controlling-visibility-with-pub.html#looking-at-the-errors)
...
#### [Fixing the Errors](ch07-02-controlling-visibility-with-pub.html#fixing-the-errors)
