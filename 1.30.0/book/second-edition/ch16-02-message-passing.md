## [Using Message Passing to Transfer Data Between Threads](ch16-02-message-passing.html#using-message-passing-to-transfer-data-between-threads)
...
### [Channels and Ownership Transference](ch16-02-message-passing.html#channels-and-ownership-transference)
...
### [Sending Multiple Values and Seeing the Receiver Waiting](ch16-02-message-passing.html#sending-multiple-values-and-seeing-the-receiver-waiting)
...
### [Creating Multiple Producers by Cloning the Transmitter](ch16-02-message-passing.html#creating-multiple-producers-by-cloning-the-transmitter)
