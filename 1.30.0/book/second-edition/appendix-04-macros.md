## [Appendix D: Macros](appendix-04-macros.html#appendix-d-macros)
...
### [The Difference Between Macros and Functions](appendix-04-macros.html#the-difference-between-macros-and-functions)
...
### [Declarative Macros with `macro_rules!` for General Metaprogramming](appendix-04-macros.html#declarative-macros-with-macro_rules-for-general-metaprogramming)
...
in Listing D-1 mean; for the full macro pattern syntax,
see [the reference](https://doc.rust-lang.org/1.30.0/reference/macros.html).
...
### [Procedural Macros for Custom `derive`](appendix-04-macros.html#procedural-macros-for-custom-derive)
...
function. The default implementation will print `Hello, Macro! My name is TypeName!` where `TypeName` is the name of the
type on which this trait has
...
and [`quote`](https://crates.io/crates/quote). The
...
documentation for `DeriveInput`](https://docs.rs/syn/0.11.11/syn/struct.DeriveInput.html) for more information.
...
docs](https://docs.rs/quote) for a thorough introduction.
...
### [The Future of Macros](appendix-04-macros.html#the-future-of-macros)
