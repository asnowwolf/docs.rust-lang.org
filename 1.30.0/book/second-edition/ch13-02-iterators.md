## [Processing a Series of Items with Iterators](ch13-02-iterators.html#processing-a-series-of-items-with-iterators)
...
### [The `Iterator` Trait and the `next` Method](ch13-02-iterators.html#the-iterator-trait-and-the-next-method)
...
### [Methods that Consume the Iterator](ch13-02-iterators.html#methods-that-consume-the-iterator)
...
### [Methods that Produce Other Iterators](ch13-02-iterators.html#methods-that-produce-other-iterators)
...
### [Using Closures that Capture Their Environment](ch13-02-iterators.html#using-closures-that-capture-their-environment)
...
### [Creating Our Own Iterators with the `Iterator` Trait](ch13-02-iterators.html#creating-our-own-iterators-with-the-iterator-trait)
...
#### [Using Our `Counter` Iterator’s `next` Method](ch13-02-iterators.html#using-our-counter-iterators-next-method)
...
#### [Using Other `Iterator` Trait Methods](ch13-02-iterators.html#using-other-iterator-trait-methods)
...
Note that `zip` produces only four pairs; the theoretical fifth pair `(5, None)` is never produced because `zip`
returns `None` when either of its input
