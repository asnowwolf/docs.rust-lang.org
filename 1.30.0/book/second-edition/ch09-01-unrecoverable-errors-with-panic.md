## [Unrecoverable Errors with `panic!`](ch09-01-unrecoverable-errors-with-panic.html#unrecoverable-errors-with-panic)
...
> ### [Unwinding the Stack or Aborting in Response to a Panic](ch09-01-unrecoverable-errors-with-panic.html#unwinding-the-stack-or-aborting-in-response-to-a-panic)
>
...
### [Using a `panic!` Backtrace](ch09-01-unrecoverable-errors-with-panic.html#using-a-panic-backtrace)
