## [Defining an Enum](ch06-01-defining-an-enum.html#defining-an-enum)
...
library has a definition we can use!](https://doc.rust-lang.org/1.30.0/std/net/enum.IpAddr.html)<!-- ignore --> Let’s
look at how
...
### [The `Option` Enum and Its Advantages Over Null Values](ch06-01-defining-an-enum.html#the-option-enum-and-its-advantages-over-null-values)
...
`Option<T>`, and it
is [defined by the standard library](https://doc.rust-lang.org/1.30.0/std/option/enum.Option.html)<!-- ignore -->
as follows:
...
them out in [its documentation](https://doc.rust-lang.org/1.30.0/std/option/enum.Option.html)<!-- ignore -->. Becoming
familiar with
