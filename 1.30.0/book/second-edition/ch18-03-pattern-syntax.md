## [Pattern Syntax](ch18-03-pattern-syntax.html#pattern-syntax)
...
### [Matching Literals](ch18-03-pattern-syntax.html#matching-literals)
...
### [Matching Named Variables](ch18-03-pattern-syntax.html#matching-named-variables)
...
### [Multiple Patterns](ch18-03-pattern-syntax.html#multiple-patterns)
...
### [Matching Ranges of Values with `...`](ch18-03-pattern-syntax.html#matching-ranges-of-values-with-)
...
convenient than using the `|` operator to express the same idea; instead of `1 ... 5`, we would have to
specify `1 | 2 | 3 | 4 | 5` if we used `|`. Specifying
...
### [Destructuring to Break Apart Values](ch18-03-pattern-syntax.html#destructuring-to-break-apart-values)
...
#### [Destructuring Structs](ch18-03-pattern-syntax.html#destructuring-structs)
...
three cases: points that lie directly on the `x` axis (which is true when `y = 0`), on the `y` axis (`x = 0`), or
neither.
...
#### [Destructuring Enums](ch18-03-pattern-syntax.html#destructuring-enums)
...
#### [Destructuring References](ch18-03-pattern-syntax.html#destructuring-references)
...
#### [Destructuring Structs and Tuples](ch18-03-pattern-syntax.html#destructuring-structs-and-tuples)
...
#### [Ignoring an Entire Value with `_`](ch18-03-pattern-syntax.html#ignoring-an-entire-value-with-_)
...
#### [Ignoring Parts of a Value with a Nested `_`](ch18-03-pattern-syntax.html#ignoring-parts-of-a-value-with-a-nested-_)
...
#### [Ignoring an Unused Variable by Starting Its Name with `_`](ch18-03-pattern-syntax.html#ignoring-an-unused-variable-by-starting-its-name-with-_)
...
#### [Ignoring Remaining Parts of a Value with `..`](ch18-03-pattern-syntax.html#ignoring-remaining-parts-of-a-value-with-)
...
### [Creating References in Patterns with `ref` and `ref mut`](ch18-03-pattern-syntax.html#creating-references-in-patterns-with-ref-and-ref-mut)
...
### [Extra Conditionals with Match Guards](ch18-03-pattern-syntax.html#extra-conditionals-with-match-guards)
...
### [`@` Bindings](ch18-03-pattern-syntax.html#a-bindings)
...
This example will print `Found an id in range: 5`. By specifying `id_variable @` before the range `3...7`, we’re
...
## [Summary](ch18-03-pattern-syntax.html#summary)
