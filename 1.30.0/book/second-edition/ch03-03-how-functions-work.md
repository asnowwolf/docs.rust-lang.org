## [Functions](ch03-03-how-functions-work.html#functions)
...
called from inside the `main` function. Note that we defined `another_function`*after* the `main` function in the source
code; we could have defined it before
...
### [Function Parameters](ch03-03-how-functions-work.html#function-parameters)
...
### [Function Bodies Contain Statements and Expressions](ch03-03-how-functions-work.html#function-bodies-contain-statements-and-expressions)
...
### [Functions with Return Values](ch03-03-how-functions-work.html#functions-with-return-values)
