...
#### [Handling Multiple Conditions with `else if`](ch03-05-control-flow.html#handling-multiple-conditions-with-else-if)
...
#### [Using `if` in a `let` Statement](ch03-05-control-flow.html#using-if-in-a-let-statement)
...
### [Repetition with Loops](ch03-05-control-flow.html#repetition-with-loops)
...
#### [Repeating Code with `loop`](ch03-05-control-flow.html#repeating-code-with-loop)
...
#### [Conditional Loops with `while`](ch03-05-control-flow.html#conditional-loops-with-while)
...
#### [Looping Through a Collection with `for`](ch03-05-control-flow.html#looping-through-a-collection-with-for)
...
## [Summary](ch03-05-control-flow.html#summary)
