## [Implementing an Object-Oriented Design Pattern](ch17-03-oo-design-patterns.html#implementing-an-object-oriented-design-pattern)
...
### [Defining `Post` and Creating a New Instance in the Draft State](ch17-03-oo-design-patterns.html#defining-post-and-creating-a-new-instance-in-the-draft-state)
...
### [Storing the Text of the Post Content](ch17-03-oo-design-patterns.html#storing-the-text-of-the-post-content)
...
### [Ensuring the Content of a Draft Post Is Empty](ch17-03-oo-design-patterns.html#ensuring-the-content-of-a-draft-post-is-empty)
...
### [Requesting a Review of the Post Changes Its State](ch17-03-oo-design-patterns.html#requesting-a-review-of-the-post-changes-its-state)
...
### [Adding the `approve` Method that Changes the Behavior of `content`](ch17-03-oo-design-patterns.html#adding-the-approve-method-that-changes-the-behavior-of-content)
...
### [Trade-offs of the State Pattern](ch17-03-oo-design-patterns.html#trade-offs-of-the-state-pattern)
...
#### [Encoding States and Behavior as Types](ch17-03-oo-design-patterns.html#encoding-states-and-behavior-as-types)
...
#### [Implementing Transitions as Transformations into Different Types](ch17-03-oo-design-patterns.html#implementing-transitions-as-transformations-into-different-types)
...
## [Summary](ch17-03-oo-design-patterns.html#summary)
